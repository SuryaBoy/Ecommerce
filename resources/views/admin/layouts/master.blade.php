  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="comp"><a href=""><i class="fa fa-dashboard"></i> <span>Company Info</span></a></li>
        <li id="judgg"><a href=""><i class="fa fa-users"></i> <span>Judges</span></a></li>
        <li id="epp"><a href=""><i class="fa fa-film"></i> <span>Episodes</span></a></li>
        <li id="contes"><a href=""><i class="fa fa-child"></i> <span>Contestants</span></a></li>
        <li id="news"><a href=""><i class="fa fa-newspaper-o"></i> <span>NewsAndUpdates</span></a></li>
        <li id="emm"><a href=""><i class="fa fa-newspaper-o"></i> <span>Send Update</span></a></li>   
        <li class="treeview">
    ...
    function readURL(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                $('.selected-img').attr('src', e.target.result).height(200);
